...
let t = fs.readFileSync('src/pages/Tickets.tsx', 'utf8'); t = t.replace('HelpCircle, Activity', 'Activity'); t = t.replace('X, Send, HelpCircle', 'X, Send, HelpCircle'); fs.writeFileSync('src/pages/Tickets.tsx', t);
